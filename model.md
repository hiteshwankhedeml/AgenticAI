...
* <mark style="color:purple;background-color:purple;">**Can we utilized with agents or standalone**</mark>
...
* <mark style="color:purple;background-color:purple;">**Models can REQUEST to call tools**</mark>
...
* <mark style="color:purple;background-color:purple;">**model.profile ⇒ information about the model**</mark> ⇒ dictionary which contains max\_token supported, tool call supported etc&#x20;
...
* <mark style="color:purple;background-color:purple;">**Prompt caching features to reduce latency and cost on repeat processing of the same tokens**</mark>
  * <mark style="color:purple;background-color:purple;">**Implicit:**</mark> <mark style="color:purple;background-color:purple;"></mark><mark style="color:purple;background-color:purple;">providers automatically pass on cost savings if a request hits a cache</mark>
  * <mark style="color:purple;background-color:purple;">**Provider-level explicit:**</mark> <mark style="color:purple;background-color:purple;"></mark><mark style="color:purple;background-color:purple;">let you manually indicate cache points for greater control or to guarantee cost savings.</mark>
  * <mark style="color:purple;background-color:purple;">**LangChain middleware:**</mark> <mark style="color:purple;background-color:purple;"></mark><mark style="color:purple;background-color:purple;">for agents, middleware lets LangChain optimize caching of stable system prompt and tool content</mark>
...
* <mark style="color:purple;background-color:purple;">**rate\_limiter:**</mark> <mark style="color:purple;background-color:purple;"></mark><mark style="color:purple;background-color:purple;">control the rate at which invocations are done</mark>
* <mark style="color:purple;background-color:purple;">**Dynamic Model Selection:**</mark>
  ...
  * <mark style="color:purple;background-color:purple;">**We can create a function with @wrap\_model\_call ⇒ in this based on conditions like message\_count we return model to be used**</mark>
  * <mark style="color:purple;background-color:purple;">**pass this in middleware while creating the agent**</mark>
